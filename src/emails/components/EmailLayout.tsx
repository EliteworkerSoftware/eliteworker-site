...
// floating on a differently-colored canvas. Header matches the site's actual
// NavBar exactly (solid --nav black, same logo), with a thin brand-gradient
// stripe underneath as the one nod to the site's gradient treatment.

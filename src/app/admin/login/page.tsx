...
export default function AdminLoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-nav px-6">
      <div className="w-full max-w-sm overflow-hidden rounded-2xl border border-nav-line bg-paper shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
        <div className="bg-nav px-8 py-7 text-center">
          <Image
